...
= 4.8.1 =
* Fixed Mismatch of EMI option Affordability Widget.

= 4.8.0 =
* Store location–specific title and description configuration.

= 4.7.9 =
* Security Enhancement.

= 4.7.8 =
* Fixed fallback to native checkout.
* Fixed duplicate checkout button.

= 4.7.7 =
* Added support for WooCommerce Cart Blocks.

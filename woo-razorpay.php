...
function woocommerce_razorpay_init()
{
    ...
    class WC_Razorpay extends WC_Payment_Gateway
    {
        ...
        protected function initHooks()
        {
            ...
            $callBack = array($this, 'process_admin_options');

            if (version_compare(WOOCOMMERCE_VERSION, '2.0.0', '>=')) {
                add_action("woocommerce_update_options_payment_gateways_{$this->id}", $callBack);
            } else {
                add_action('woocommerce_update_options_payment_gateways', $callBack);
            }
        }
        ...
        protected function createOrGetRazorpayOrderId($orderId)
        {
            ...
            try {
                ...
                if (($razorpayOrderId === null) or (($razorpayOrderId and ($this->verifyOrderAmount($razorpayOrderId, $orderId)) === false))) {
                    $create = true;
                } else {
        ...
        protected function getRazorpayPaymentParams($orderId)
        {
            ...
            } elseif ($razorpayOrderId instanceof Exception) {
         ...
         **/
        public function generateOrderForm($data)
        {
...
EOT;
         ...
         **/
        public function check_razorpay_response()
        {
            global $woocommerce;
